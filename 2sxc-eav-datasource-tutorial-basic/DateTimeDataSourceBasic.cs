...
namespace ToSic.Tutorial.DataSource
{
    ...
    [VisualQuery(
        ...
        GlobalName = "7aee541c-7188-429f-a4bb-2663a576b19e",   // recommended to use namespace or guid
    ...
    public class DateTimeDataSourceBasic: ExternalDataDataSource
    {
        ...
        /// <summary>
        /// Constructor - basically tells the system what out-streams we will provide
        /// </summary>
        public DateTimeDataSourceBasic()
        {
            Provide(GetList); // wire up the default out, if accessed, will deliver GetList
        }

        /// <summary>
        /// Get-List method, which will load/build the items once requested 
        /// Note that the setup is lazy-loading, so this code will not execute unless it's really used
        /// </summary>
        /// <returns></returns>
